...
public class UI_Holographic_MoveBall : MonoBehaviour
{
    ...
    void Start ()
    {
        _movementBall = ManagerObjects.Instance().GetObject(EnumObjects.MovementShere);
        _uiCenterPointMoveBall = ManagerObjects.Instance().GetObject(EnumObjects.UICenterPointMoveBall);
